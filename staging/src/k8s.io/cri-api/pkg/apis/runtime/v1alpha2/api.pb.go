...
type ContainerEventMessage_EventType int32

const (
	ContainerEventMessage_Unspecified      ContainerEventMessage_EventType = 0
	ContainerEventMessage_ContainerCreated ContainerEventMessage_EventType = 1
	ContainerEventMessage_ContainerStarted ContainerEventMessage_EventType = 2
	ContainerEventMessage_ContainerUpdated ContainerEventMessage_EventType = 3
	ContainerEventMessage_ContainerStopped ContainerEventMessage_EventType = 4
	ContainerEventMessage_ContainerDeleted ContainerEventMessage_EventType = 5
)

var ContainerEventMessage_EventType_name = map[int32]string{
	0: "Unspecified",
	1: "ContainerCreated",
	2: "ContainerStarted",
	3: "ContainerUpdated",
...
var ContainerEventMessage_EventType_value = map[string]int32{
	"Unspecified":      0,
	"ContainerCreated": 1,
	"ContainerStarted": 2,
	"ContainerUpdated": 3,
...
func (x ContainerEventMessage_EventType) String() string {
	return proto.EnumName(ContainerEventMessage_EventType_name, int32(x))
}

func (ContainerEventMessage_EventType) EnumDescriptor() ([]byte, []int) {
...
type SubscribeContainerEventRequest struct {
	// List of labels that should be included in response if exists
	WithLabels []string `protobuf:"bytes,1,rep,name=withLabels,proto3" json:"withLabels,omitempty"`
	// List of annotations that should be included in response if exists
	WithAnnotations      []string `protobuf:"bytes,2,rep,name=withAnnotations,proto3" json:"withAnnotations,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *SubscribeContainerEventRequest) Reset()      { *m = SubscribeContainerEventRequest{} }
func (*SubscribeContainerEventRequest) ProtoMessage() {}
func (*SubscribeContainerEventRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_00212fb1f9d3bf1c, []int{60}
}
func (m *SubscribeContainerEventRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SubscribeContainerEventRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SubscribeContainerEventRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SubscribeContainerEventRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SubscribeContainerEventRequest.Merge(m, src)
}
func (m *SubscribeContainerEventRequest) XXX_Size() int {
	return m.Size()
}
func (m *SubscribeContainerEventRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SubscribeContainerEventRequest.DiscardUnknown(m)
}

var xxx_messageInfo_SubscribeContainerEventRequest proto.InternalMessageInfo

func (m *SubscribeContainerEventRequest) GetWithLabels() []string {
	if m != nil {
		return m.WithLabels
	}
	return nil
...
func (m *SubscribeContainerEventRequest) GetWithAnnotations() []string {
	if m != nil {
		return m.WithAnnotations
	}
	return nil
}
...
type ContainerEventMessage struct {
	// Type of event
	EventType ContainerEventMessage_EventType `protobuf:"varint,1,opt,name=event_type,json=eventType,proto3,enum=runtime.v1alpha2.ContainerEventMessage_EventType" json:"event_type,omitempty"`
	// ID of the container or sandbox
	ContainerId string `protobuf:"bytes,2,opt,name=container_id,json=containerId,proto3" json:"container_id,omitempty"`
	// ID of the sandbox associatet within container
...
func (m *ContainerEventMessage) Reset()      { *m = ContainerEventMessage{} }
func (*ContainerEventMessage) ProtoMessage() {}
func (*ContainerEventMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_00212fb1f9d3bf1c, []int{61}
}
func (m *ContainerEventMessage) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ContainerEventMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ContainerEventMessage.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ContainerEventMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ContainerEventMessage.Merge(m, src)
}
func (m *ContainerEventMessage) XXX_Size() int {
	return m.Size()
}
func (m *ContainerEventMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_ContainerEventMessage.DiscardUnknown(m)
}

var xxx_messageInfo_ContainerEventMessage proto.InternalMessageInfo

func (m *ContainerEventMessage) GetEventType() ContainerEventMessage_EventType {
	if m != nil {
		return m.EventType
	}
	return ContainerEventMessage_Unspecified
}

func (m *ContainerEventMessage) GetContainerId() string {
	if m != nil {
		return m.ContainerId
	}
	return ""
...
func (m *ContainerEventMessage) GetSandboxId() string {
	if m != nil {
		return m.SandboxId
	}
	return ""
...
func (m *ContainerEventMessage) GetLabels() map[string]string {
	if m != nil {
		return m.Labels
	}
	return nil
...
func (m *ContainerEventMessage) GetAnnotations() map[string]string {
	if m != nil {
		return m.Annotations
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("runtime.v1alpha2.ContainerEventMessage_EventType", ContainerEventMessage_EventType_name, ContainerEventMessage_EventType_value)
	...
	proto.RegisterType((*SubscribeContainerEventRequest)(nil), "runtime.v1alpha2.SubscribeContainerEventRequest")
	proto.RegisterType((*ContainerEventMessage)(nil), "runtime.v1alpha2.ContainerEventMessage")
	proto.RegisterMapType((map[string]string)(nil), "runtime.v1alpha2.ContainerEventMessage.AnnotationsEntry")
	proto.RegisterMapType((map[string]string)(nil), "runtime.v1alpha2.ContainerEventMessage.LabelsEntry")
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
...
type RuntimeServiceClient interface {
	...
	SubscribeContainerEvent(ctx context.Context, in *SubscribeContainerEventRequest, opts ...grpc.CallOption) (RuntimeService_SubscribeContainerEventClient, error)
...
func (c *runtimeServiceClient) SubscribeContainerEvent(ctx context.Context, in *SubscribeContainerEventRequest, opts ...grpc.CallOption) (RuntimeService_SubscribeContainerEventClient, error) {
	stream, err := c.cc.NewStream(ctx, &_RuntimeService_serviceDesc.Streams[0], "/runtime.v1alpha2.RuntimeService/SubscribeContainerEvent", opts...)
	if err != nil {
		return nil, err
	}
	x := &runtimeServiceSubscribeContainerEventClient{stream}
...
type RuntimeService_SubscribeContainerEventClient interface {
	Recv() (*ContainerEventMessage, error)
	grpc.ClientStream
}

type runtimeServiceSubscribeContainerEventClient struct {
	grpc.ClientStream
}

func (x *runtimeServiceSubscribeContainerEventClient) Recv() (*ContainerEventMessage, error) {
	m := new(ContainerEventMessage)
...
type RuntimeServiceServer interface {
	...
	// SubscribeContainerEvent returns ContainerEventMessage stream
	SubscribeContainerEvent(*SubscribeContainerEventRequest, RuntimeService_SubscribeContainerEventServer) error
	// UpdateContainerResources updates ContainerConfig of the container.
...
func (*UnimplementedRuntimeServiceServer) SubscribeContainerEvent(req *SubscribeContainerEventRequest, srv RuntimeService_SubscribeContainerEventServer) error {
	return status.Errorf(codes.Unimplemented, "method SubscribeContainerEvent not implemented")
}
...
func _RuntimeService_SubscribeContainerEvent_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(SubscribeContainerEventRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(RuntimeServiceServer).SubscribeContainerEvent(m, &runtimeServiceSubscribeContainerEventServer{stream})
}

type RuntimeService_SubscribeContainerEventServer interface {
	Send(*ContainerEventMessage) error
	grpc.ServerStream
}

type runtimeServiceSubscribeContainerEventServer struct {
	grpc.ServerStream
}

func (x *runtimeServiceSubscribeContainerEventServer) Send(m *ContainerEventMessage) error {
...
var _RuntimeService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "SubscribeContainerEvent",
			Handler:       _RuntimeService_SubscribeContainerEvent_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "api.proto",
...
func (m *SubscribeContainerEventRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SubscribeContainerEventRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SubscribeContainerEventRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.WithAnnotations) > 0 {
		for iNdEx := len(m.WithAnnotations) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.WithAnnotations[iNdEx])
			copy(dAtA[i:], m.WithAnnotations[iNdEx])
			i = encodeVarintApi(dAtA, i, uint64(len(m.WithAnnotations[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.WithLabels) > 0 {
		for iNdEx := len(m.WithLabels) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.WithLabels[iNdEx])
			copy(dAtA[i:], m.WithLabels[iNdEx])
			i = encodeVarintApi(dAtA, i, uint64(len(m.WithLabels[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *ContainerEventMessage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ContainerEventMessage) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ContainerEventMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SubscribeContainerEventRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.WithLabels) > 0 {
		for _, s := range m.WithLabels {
			l = len(s)
			n += 1 + l + sovApi(uint64(l))
		}
	}
	if len(m.WithAnnotations) > 0 {
		for _, s := range m.WithAnnotations {
			l = len(s)
			n += 1 + l + sovApi(uint64(l))
		}
	}
...
func (m *ContainerEventMessage) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *SubscribeContainerEventRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SubscribeContainerEventRequest{`,
		`WithLabels:` + fmt.Sprintf("%v", this.WithLabels) + `,`,
		`WithAnnotations:` + fmt.Sprintf("%v", this.WithAnnotations) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ContainerEventMessage) String() string {
	if this == nil {
		return "nil"
	}
	keysForLabels := make([]string, 0, len(this.Labels))
	...
	mapStringForAnnotations += "}"
	s := strings.Join([]string{`&ContainerEventMessage{`,
...
func (m *SubscribeContainerEventRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SubscribeContainerEventRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SubscribeContainerEventRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WithLabels", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.WithLabels = append(m.WithLabels, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WithAnnotations", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.WithAnnotations = append(m.WithAnnotations, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipApi(dAtA[iNdEx:])
...
func (m *ContainerEventMessage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ContainerEventMessage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ContainerEventMessage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EventType |= ContainerEventMessage_EventType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
