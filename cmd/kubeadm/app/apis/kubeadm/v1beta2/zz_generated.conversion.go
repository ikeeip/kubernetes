...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*KubeProxyAddon)(nil), (*kubeadm.KubeProxyAddon)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_KubeProxyAddon_To_kubeadm_KubeProxyAddon(a.(*KubeProxyAddon), b.(*kubeadm.KubeProxyAddon), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*kubeadm.KubeProxyAddon)(nil), (*KubeProxyAddon)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kubeadm_KubeProxyAddon_To_v1beta2_KubeProxyAddon(a.(*kubeadm.KubeProxyAddon), b.(*KubeProxyAddon), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_ClusterConfiguration_To_kubeadm_ClusterConfiguration(in *ClusterConfiguration, out *kubeadm.ClusterConfiguration, s conversion.Scope) error {
	...
	if err := Convert_v1beta2_KubeProxyAddon_To_kubeadm_KubeProxyAddon(&in.KubeProxyAddon, &out.KubeProxyAddon, s); err != nil {
		return err
	}
...
func autoConvert_kubeadm_ClusterConfiguration_To_v1beta2_ClusterConfiguration(in *kubeadm.ClusterConfiguration, out *ClusterConfiguration, s conversion.Scope) error {
	...
	if err := Convert_kubeadm_KubeProxyAddon_To_v1beta2_KubeProxyAddon(&in.KubeProxyAddon, &out.KubeProxyAddon, s); err != nil {
		return err
	}
	out.CertificatesDir = in.CertificatesDir
	out.ImageRepository = in.ImageRepository
...
func autoConvert_v1beta2_KubeProxyAddon_To_kubeadm_KubeProxyAddon(in *KubeProxyAddon, out *kubeadm.KubeProxyAddon, s conversion.Scope) error {
	out.NodeSelector = in.NodeSelector
	return nil
}

// Convert_v1beta2_KubeProxyAddon_To_kubeadm_KubeProxyAddon is an autogenerated conversion function.
func Convert_v1beta2_KubeProxyAddon_To_kubeadm_KubeProxyAddon(in *KubeProxyAddon, out *kubeadm.KubeProxyAddon, s conversion.Scope) error {
	return autoConvert_v1beta2_KubeProxyAddon_To_kubeadm_KubeProxyAddon(in, out, s)
}

func autoConvert_kubeadm_KubeProxyAddon_To_v1beta2_KubeProxyAddon(in *kubeadm.KubeProxyAddon, out *KubeProxyAddon, s conversion.Scope) error {
	out.NodeSelector = in.NodeSelector
	return nil
}

// Convert_kubeadm_KubeProxyAddon_To_v1beta2_KubeProxyAddon is an autogenerated conversion function.
func Convert_kubeadm_KubeProxyAddon_To_v1beta2_KubeProxyAddon(in *kubeadm.KubeProxyAddon, out *KubeProxyAddon, s conversion.Scope) error {
	return autoConvert_kubeadm_KubeProxyAddon_To_v1beta2_KubeProxyAddon(in, out, s)
}
